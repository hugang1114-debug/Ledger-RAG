# Gate 8 Main v1 Validator-only Prompt Candidate
...
This is the Validator-only baseline. Citations may reference retrieved evidence ids when available, but verifier verdicts are produced after generation. Do not use verifier feedback while writing the answer.
