# Gate 8 Main v1 Citation-only Prompt Candidate
...
This is the Citation-only baseline. Each factual atomic claim must cite one or more retrieved evidence ids from the current run. Do not cite evidence ids that were not provided.
